...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '一个热爱代码的计算机爱好者，记录学习与成长的点滴,技术爱好者的个人笔记，记录每一次代码的进步与突破,探索编程的世界，分享技术灵感与项目实践,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xiaoYu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A computer enthusiast', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yanjia.love', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Personal Blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jia12262003@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/03jia', // 你的github个人主页 例如 https://github.com/tangly1024
